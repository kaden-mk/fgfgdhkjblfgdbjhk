...
class OptionsMenu extends MusicBeatState
{
	...
	new OptionCategory("Scrolls", [
	new DownscrollOption("Change the layout of the strumline."),
	new MiddleScrollOption("Make the strumline in the middle, doesn't work.")
	]),
	new OptionCategory("Notes", [
		new CpuStrums("The enemy hits his notes like uh idk"),
		new NoteSplashOption("Poggers")
	]),
	new OptionCategory("Gameplay", [
		new DFJKOption(controls),
		new AccuracyDOption("Display information.")
	])
