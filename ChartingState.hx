...
class ChartingState extends MusicBeatState
{
	...
	var noteType:Int = 0;
	var typeNames:Array<String> = ['normal', 'hell', 'trickyNotes'];
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		if (!typingShit.hasFocus)
		{
            ...
            if (FlxG.keys.justPressed.X){
                trace("Changing note");
                this.noteType ++;
                if (noteType == typeNames.length - 1){
                    noteType = 0;
                }
            }
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
        	...
        	var note:Note = new Note(daStrumTime, daNoteInfo % 4, false, daType);
	...
	private function addNote():Void
	{
		...
		var noteSus = 0;
		var noteType = typeNames[this.noteType];
